...
\setthesisinfoLV
  ...
  {Ashithosh Nithin}% LV Student
  {Dr.sc.ing.prof. Andrejs Bondarenko}% LV Supervisor
  {Bakalaura grāds datorzinatne un informatikā}% LV Study programme
  {Informācijas sistēmas}% LV Department
  {2026}% Year

\setthesisinfoEN
  {Forecasting University Enrollment Demand in the United States Using IPEDS Administrative Panel Data (2010--2021)}% EN Title
  {Ashithosh Nithin}% EN Student
  {Dr.sc.ing.prof. Andrejs Bondarenko}% EN Supervisor
  {Bachelor of Computer Science and Informatics}% EN Study programme
  {Information Systems}% EN Department
  {2026}% Year
